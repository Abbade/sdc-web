  ...
  return (
    <Box sx={{ flexGrow: 1 }}>
      ...
      <Table
        ...
        pageSize={pageSize}
        rowCount={rowCount}
        searchName="Procurar Localização"
        onAdd={onAdd}
      />
      <FormDialog onClose={onClose} open={openForm} title='Localização'
      >
        <CreateLocationForm id={idItem} onClose={onClose} />
      </FormDialog>
    </Box>
  );
}
