  ...
  return (
    <Box sx={{ flexGrow: 1 }}>
      ...
      <Table
        ...
        pageSize={pageSize}
        rowCount={rowCount}
        searchName="Procurar Perfil Genético"
        onAdd={onAdd}
      />
      <FormDialog onClose={onClose} open={openForm} title='Perfil Genético'
      >
        <CreateGeneticProfileForm id={idItem} onClose={onClose} />
      </FormDialog>
    </Box>
  );
}
