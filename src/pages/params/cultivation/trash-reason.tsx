  ...
  return (
    <Box sx={{ flexGrow: 1 }}>
      ...
      <Table
        ...
        pageSize={pageSize}
        rowCount={rowCount}
        searchName="Procurar Motivo Descarte"
        onAdd={onAdd}
      />
      <FormDialog onClose={onClose} open={openForm} title="Motivo Descarte">
        <CreateTrashReasonForm id={idItem} onClose={onClose} />
      </FormDialog>
    </Box>
  );
}
